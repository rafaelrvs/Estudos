...
public class FormVeiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Preço com desconto");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        veiculo.marca = jTextField1.getText();
        veiculo.modelo = jTextField2.getText();
        veiculo.setAno( Integer.parseInt(jTextField3.getText()));
        veiculo.setValor(Double.parseDouble(jTextField4.getText())); 
        
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(null," O valor do veiculo é: \n Marca: " + veiculo.marca+ "\n modelo: " + veiculo.modelo + "\n ano: " + veiculo.getAno() + "\n valor: " + veiculo.getValor());
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      
        desconto = veiculo.calcularDesconto();
       jLabel6.setText(Double.toString(desconto));
